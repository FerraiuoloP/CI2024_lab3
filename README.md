...
On my hardware, 3x3 grids are typically solved in just a few seconds. For 4x4 grids, the process can take up to ~10 minutes (using 100,000 RANDOMIZE_STEPS). Grids of 5x5 or larger require significantly more time to solve.
